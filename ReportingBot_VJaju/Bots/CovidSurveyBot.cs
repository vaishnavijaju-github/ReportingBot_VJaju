...
namespace ReportingBot_VJaju.Bots
{
    public class CovidSurveyBot<T> : DialogBot<T>
        where T : Dialog
    {
        public CovidSurveyBot(ConversationState conversationState, UserState userState, T dialog, ILogger<DialogBot<T>> logger)
